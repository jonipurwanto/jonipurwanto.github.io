...
function setupRW() {
	...
	debug_log("JAILBREAK BERHASIL TEKAN KEMBALI ( BACK ) DI STICK SEKALI SETELAH MUNCUL LOGO HEN DI POJOK KIRI ATAS LALU TEKAN LOGO PS DI STIK.");
...
function sprayHTMLTextArea() {
	debug_log("MOHON TUNGGU SEDANG MENJAILBREAK....");
